        ...
        <div className="flex justify-between items-center h-16 sm:h-20">
          ...
          >
            <div className="relative">
              ...
              <div className="absolute -top-1 -right-1 w-2 sm:w-3 h-2 sm:h-3 bg-green-400 rounded-full border-2 border-white animate-pulse"></div>
            </div>
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] sm:text-xs text-gray-500 font-medium hidden sm:block">Powered by AI</span>
            </div>
          </motion.div>
          ...
          {isMobile && isMenuOpen && (
            ...
            >
              <div className="py-4 space-y-2">
                {user ? (
                  <>
                    <div className="px-4 py-2 bg-amber-50 rounded-lg mb-3">
